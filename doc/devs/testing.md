...
operation_tests      // Unit Tests of Morphene operations
operation_time_tests // Tests of Morphene operations that include a time based component (ex. vesting withdrawals)
...
```
cmake -D BUILD_MORPHENE_TESTNET=ON -D ENABLE_COVERAGE_TESTING=true -D CMAKE_BUILD_TYPE=Debug .
make
