...
#include <morphene/chain/shared_authority.hpp>
...
namespace morphene { namespace chain {
   ...
   using morphene::protocol::authority;
   ...
   class account_object : public object< account_object_type, account_object >
   {
      ...
      public:
         ...
         legacy_asset      vesting_shares = legacy_asset( 0, VESTS_SYMBOL ); ///< total vesting shares held by this account, controls its voting power
         legacy_asset      delegated_vesting_shares = legacy_asset( 0, VESTS_SYMBOL );
         legacy_asset      received_vesting_shares = legacy_asset( 0, VESTS_SYMBOL );

         legacy_asset      vesting_withdraw_rate = legacy_asset( 0, VESTS_SYMBOL ); ///< at the time this is updated it can be at most vesting_shares/104
         time_point_sec    next_vesting_withdrawal = fc::time_point_sec::maximum(); ///< after every withdrawal this is incremented by 1 week
         share_type        withdrawn = 0; /// Track how many shares have been withdrawn
         share_type        to_withdraw = 0; /// Might be able to look this up with operation history.
         uint16_t          withdraw_routes = 0;

         fc::array<share_type, MORPHENE_MAX_PROXY_RECURSION_DEPTH> proxied_vsf_votes;// = std::vector<share_type>( MORPHENE_MAX_PROXY_RECURSION_DEPTH, 0 ); ///< the total VFS votes proxied to this account
...
CHAINBASE_SET_INDEX_TYPE( morphene::chain::account_object, morphene::chain::account_index )

FC_REFLECT( morphene::chain::account_authority_object,
             (id)(account)(owner)(active)(posting)(last_owner_update)
)
CHAINBASE_SET_INDEX_TYPE( morphene::chain::account_authority_object, morphene::chain::account_authority_index )

FC_REFLECT( morphene::chain::vesting_delegation_object,
            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )
CHAINBASE_SET_INDEX_TYPE( morphene::chain::vesting_delegation_object, morphene::chain::vesting_delegation_index )

FC_REFLECT( morphene::chain::vesting_delegation_expiration_object,
            (id)(delegator)(vesting_shares)(expiration) )
CHAINBASE_SET_INDEX_TYPE( morphene::chain::vesting_delegation_expiration_object, morphene::chain::vesting_delegation_expiration_index )

FC_REFLECT( morphene::chain::owner_authority_history_object,
             (id)(account)(previous_owner_authority)(last_valid_time)
          )
CHAINBASE_SET_INDEX_TYPE( morphene::chain::owner_authority_history_object, morphene::chain::owner_authority_history_index )

FC_REFLECT( morphene::chain::account_recovery_request_object,
             (id)(account_to_recover)(new_owner_authority)(expires)
          )
CHAINBASE_SET_INDEX_TYPE( morphene::chain::account_recovery_request_object, morphene::chain::account_recovery_request_index )

FC_REFLECT( morphene::chain::change_recovery_account_request_object,
             (id)(account_to_recover)(recovery_account)(effective_on)
          )
CHAINBASE_SET_INDEX_TYPE( morphene::chain::change_recovery_account_request_object, morphene::chain::change_recovery_account_request_index )
