...
FC_REFLECT( morphene::chain::block_summary_object, (id)(block_id) )
CHAINBASE_SET_INDEX_TYPE( morphene::chain::block_summary_object, morphene::chain::block_summary_index )
