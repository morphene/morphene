...
#include <morphene/protocol/schema_types.hpp>
#include <morphene/chain/schema_types.hpp>
   ...
   : public custom_operation_interpreter, public evaluator_registry< CustomOperationType >
{
   public:
      ...
      virtual std::shared_ptr< morphene::schema::abstract_schema > get_operation_schema() override
      {
         return morphene::schema::get_schema_for_type< CustomOperationType >();
      }
};
