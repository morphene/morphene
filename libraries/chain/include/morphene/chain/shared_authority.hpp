...
namespace morphene { namespace chain {
   ...
   using morphene::protocol::weight_type;
...
FC_REFLECT_TYPENAME( morphene::chain::shared_authority::account_authority_map)
FC_REFLECT( morphene::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
