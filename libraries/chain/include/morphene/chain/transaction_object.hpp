...
FC_REFLECT( morphene::chain::transaction_object, (id)(packed_trx)(trx_id)(expiration) )
CHAINBASE_SET_INDEX_TYPE( morphene::chain::transaction_object, morphene::chain::transaction_index )

namespace helpers
{
   template <>
   class index_statistic_provider<morphene::chain::transaction_index>
   {
   public:
      typedef morphene::chain::transaction_index IndexType;
      typedef typename morphene::chain::transaction_object::t_packed_trx t_packed_trx;
