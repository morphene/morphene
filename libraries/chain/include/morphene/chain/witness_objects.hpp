...
#include <morphene/chain/util/rd_dynamics.hpp>
...
namespace morphene { namespace chain {
   ...
   using morphene::protocol::digest_type;
   using morphene::protocol::public_key_type;
   using morphene::protocol::version;
   using morphene::protocol::hardfork_version;
   ...
   using morphene::chain::util::rd_dynamics_params;
   ...
   struct chain_properties
   {
      ...
      legacy_asset             account_creation_fee =
         legacy_asset( MORPHENE_MIN_ACCOUNT_CREATION_FEE, MORPH_SYMBOL );
       ...
       * Scaled so that MORPHENE_ACCOUNT_SUBSIDY_PRECISION represents one account.
       */
       ...
       * Scaled so that 1 << MORPHENE_RD_DECAY_DENOM_SHIFT represents 100% of accounts
       * expiring.
       */
   ...
   class witness_object : public object< witness_object_type, witness_object >
   {
      ...
      public:
         ...
         time_point_sec    hardfork_time_vote = MORPHENE_GENESIS_TIME;
   ...
   class witness_schedule_object : public object< witness_schedule_object_type, witness_schedule_object >
   {
      public:
         ...
         fc::array< account_name_type, MORPHENE_MAX_WITNESSES >            current_shuffled_witnesses;
...
FC_REFLECT( morphene::chain::witness_object,
             (id)
             (owner)
             (created)
...
CHAINBASE_SET_INDEX_TYPE( morphene::chain::witness_object, morphene::chain::witness_index )

FC_REFLECT( morphene::chain::witness_vote_object, (id)(witness)(account) )
CHAINBASE_SET_INDEX_TYPE( morphene::chain::witness_vote_object, morphene::chain::witness_vote_index )
...
CHAINBASE_SET_INDEX_TYPE( morphene::chain::witness_schedule_object, morphene::chain::witness_schedule_index )
