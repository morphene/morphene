...
#include <morphene/plugins/block_info/block_info_api.hpp>
#include <morphene/plugins/block_info/block_info_plugin.hpp>
...
{
   public:
      block_info_api_impl( morphene::app::application& _app );

      std::shared_ptr< morphene::plugin::block_info::block_info_plugin > get_plugin();
...
block_info_api_impl::block_info_api_impl( morphene::app::application& _app ) : app( _app )
{}

std::shared_ptr< morphene::plugin::block_info::block_info_plugin > block_info_api_impl::get_plugin()
{
...
block_info_api::block_info_api( const morphene::app::api_context& ctx )
{
