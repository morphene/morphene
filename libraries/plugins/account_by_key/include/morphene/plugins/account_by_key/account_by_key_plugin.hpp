...
#define MORPHENE_ACCOUNT_BY_KEY_PLUGIN_NAME "account_by_key"
...
class account_by_key_plugin : public appbase::plugin< account_by_key_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = MORPHENE_ACCOUNT_BY_KEY_PLUGIN_NAME; return name; }
