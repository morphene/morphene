...
#ifndef MORPHENE_ACCOUNT_HISTORY_ROCKSDB_SPACE_ID
#define MORPHENE_ACCOUNT_HISTORY_ROCKSDB_SPACE_ID 15
#endif
...
{
   volatile_operation_object_type = ( MORPHENE_ACCOUNT_HISTORY_ROCKSDB_SPACE_ID << 8 )
};
...
} } } // morphene::plugins::account_history_rocksdb

FC_REFLECT( morphene::plugins::account_history_rocksdb::volatile_operation_object, (id)(trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(serialized_op)(impacted) )
CHAINBASE_SET_INDEX_TYPE( morphene::plugins::account_history_rocksdb::volatile_operation_object, morphene::plugins::account_history_rocksdb::volatile_operation_index )

FC_REFLECT( morphene::plugins::account_history_rocksdb::rocksdb_operation_object, (id)(trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(serialized_op) )
