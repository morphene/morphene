...
#define MORPHENE_ACCOUNT_HISTORY_API_PLUGIN_NAME "account_history_api"
...
public:
   ...
   static const std::string& name() { static std::string name = MORPHENE_ACCOUNT_HISTORY_API_PLUGIN_NAME; return name; }
