#include <morphene/plugins/debug_node_api/debug_node_api_plugin.hpp>
#include <morphene/plugins/debug_node_api/debug_node_api.hpp>
...
{
   if( args.hardfork_id > MORPHENE_NUM_HARDFORKS )
      return {};
...
{
   JSON_RPC_REGISTER_API( MORPHENE_DEBUG_NODE_API_PLUGIN_NAME );
}
