...
#define MORPHENE_NETWORK_BROADCAST_API_PLUGIN_NAME "network_broadcast_api"
...
public:
   ...
   static const std::string& name() { static std::string name = MORPHENE_NETWORK_BROADCAST_API_PLUGIN_NAME; return name; }
