...
namespace morphene { namespace plugins { namespace block_data_export {
...
FC_REFLECT( morphene::plugins::block_data_export::detail::api_export_data_object, (block_id)(previous)(export_data) )

namespace morphene { namespace plugins { namespace block_data_export { namespace detail {
...
} } } // morphene::plugins::block_data_export
