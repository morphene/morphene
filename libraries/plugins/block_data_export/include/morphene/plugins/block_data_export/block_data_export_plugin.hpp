...
#define MORPHENE_BLOCK_DATA_EXPORT_PLUGIN_NAME "block_data_export"
...
class block_data_export_plugin : public appbase::plugin< block_data_export_plugin >
{
   public:
      ...
      APPBASE_PLUGIN_REQUIRES( (morphene::plugins::chain::chain_plugin) )

      static const std::string& name() { static std::string name = MORPHENE_BLOCK_DATA_EXPORT_PLUGIN_NAME; return name; }
