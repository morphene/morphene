...
#include <morphene/plugins/p2p/p2p_default_seeds.hpp>
...
using morphene::protocol::block_header;
...
public:
   ...
   virtual morphene::protocol::chain_id_type get_chain_id() const override;
...
morphene::protocol::chain_id_type p2p_plugin_impl::get_chain_id() const
{
...
void p2p_plugin::plugin_initialize(const boost::program_options::variables_map& options)
{
   ...
   my->user_agent = "Morphene Reference Implementation";
...
void p2p_plugin::broadcast_block( const morphene::protocol::signed_block& block )
{
   ulog("Broadcasting block #${n}", ("n", block.block_num()));
   my->node->broadcast( graphene::net::block_message( block ) );
}

void p2p_plugin::broadcast_transaction( const morphene::protocol::signed_transaction& tx )
{
...
} } } // namespace morphene::plugins::p2p
