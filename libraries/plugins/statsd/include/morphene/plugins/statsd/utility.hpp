#pragma once
#include <morphene/plugins/statsd/statsd_plugin.hpp>
...
using morphene::plugins::statsd::statsd_plugin;
...
if( morphene::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   morphene::plugins::statsd::util::get_statsd().increment( \
...
if( morphene::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   morphene::plugins::statsd::util::get_statsd().decrement( \
      NAMESPACE, STAT, KEY, FREQ                         \
   );                                                    \
}
...
if( morphene::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   morphene::plugins::statsd::util::get_statsd().count(     \
...
if( morphene::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   morphene::plugins::statsd::util::get_statsd().gauge(     \
      NAMESPACE, STAT, KEY, VAL, FREQ                    \
   );                                                    \
}
...
fc::optional< morphene::plugins::statsd::util::statsd_timer_helper > statsd_timer;  \
if( morphene::plugins::statsd::util::statsd_enabled() )                             \
{                                                                                \
   statsd_timer = morphene::plugins::statsd::util::statsd_timer_helper(             \
      NAMESPACE, STAT, KEY, FREQ, morphene::plugins::statsd::util::get_statsd()     \
   );                                                                            \
}
...
if( morphene::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   morphene::plugins::statsd::util::get_statsd().timing(    \
      NAMESPACE, STAT, KEY,                              \
      morphene::plugins::statsd::util::timing_helper( VAL ),\
      FREQ                                               \
   );                                                    \
}
