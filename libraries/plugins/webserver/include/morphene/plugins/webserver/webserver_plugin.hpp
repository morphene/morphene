...
#define MORPHENE_WEBSERVER_PLUGIN_NAME "webserver"

namespace morphene { namespace plugins { namespace webserver {
...
class webserver_plugin : public appbase::plugin< webserver_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = MORPHENE_WEBSERVER_PLUGIN_NAME; return name; }
