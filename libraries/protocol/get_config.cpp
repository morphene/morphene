...
fc::variant_object get_config()
{
   ...
   result["MORPHENE_ACTIVE_CHALLENGE_COOLDOWN"] = MORPHENE_ACTIVE_CHALLENGE_COOLDOWN;
   result["MORPHENE_ACTIVE_CHALLENGE_FEE"] = MORPHENE_ACTIVE_CHALLENGE_FEE;
   ...
   result["MORPHENE_APR_PERCENT_MULTIPLY_PER_HOUR"] = MORPHENE_APR_PERCENT_MULTIPLY_PER_HOUR;
   result["MORPHENE_APR_PERCENT_MULTIPLY_PER_ROUND"] = MORPHENE_APR_PERCENT_MULTIPLY_PER_ROUND;
   result["MORPHENE_APR_PERCENT_SHIFT_PER_BLOCK"] = MORPHENE_APR_PERCENT_SHIFT_PER_BLOCK;
   result["MORPHENE_APR_PERCENT_SHIFT_PER_HOUR"] = MORPHENE_APR_PERCENT_SHIFT_PER_HOUR;
   result["MORPHENE_APR_PERCENT_SHIFT_PER_ROUND"] = MORPHENE_APR_PERCENT_SHIFT_PER_ROUND;
   result["MORPHENE_BANDWIDTH_AVERAGE_WINDOW_SECONDS"] = MORPHENE_BANDWIDTH_AVERAGE_WINDOW_SECONDS;
   result["MORPHENE_BANDWIDTH_PRECISION"] = MORPHENE_BANDWIDTH_PRECISION;
   result["MORPHENE_BLOCKCHAIN_PRECISION"] = MORPHENE_BLOCKCHAIN_PRECISION;
   result["MORPHENE_BLOCKCHAIN_PRECISION_DIGITS"] = MORPHENE_BLOCKCHAIN_PRECISION_DIGITS;
   ...
   result["MORPHENE_CONTENT_CONSTANT"] = MORPHENE_CONTENT_CONSTANT;
   ...
   result["MORPHENE_MAX_INSTANCE_ID"] = MORPHENE_MAX_INSTANCE_ID;
   result["MORPHENE_MAX_MEMO_SIZE"] = MORPHENE_MAX_MEMO_SIZE;
   result["MORPHENE_MAX_WITNESSES"] = MORPHENE_MAX_WITNESSES;
   result["MORPHENE_MAX_PERMLINK_LENGTH"] = MORPHENE_MAX_PERMLINK_LENGTH;
   ...
   result["MORPHENE_MIN_PERMLINK_LENGTH"] = MORPHENE_MIN_PERMLINK_LENGTH;
   ...
   result["MORPHENE_OWNER_CHALLENGE_COOLDOWN"] = MORPHENE_OWNER_CHALLENGE_COOLDOWN;
   result["MORPHENE_OWNER_CHALLENGE_FEE"] = MORPHENE_OWNER_CHALLENGE_FEE;
   ...
   result["MORPHENE_VIRTUAL_SCHEDULE_LAP_LENGTH2"] = MORPHENE_VIRTUAL_SCHEDULE_LAP_LENGTH2;
