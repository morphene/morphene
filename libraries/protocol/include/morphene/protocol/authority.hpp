 ...
 * - Length is between (inclusive) MORPHENE_MIN_ACCOUNT_NAME_LENGTH and MORPHENE_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace morphene::protocol


FC_REFLECT_TYPENAME( morphene::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( morphene::protocol::authority::key_authority_map)
FC_REFLECT( morphene::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( morphene::protocol::authority::classification, (owner)(active)(key)(posting) )
