...
FC_REFLECT_TYPENAME( morphene::protocol::block_header_extensions )

FC_REFLECT( morphene::protocol::block_header, (previous)(timestamp)(witness)(transaction_merkle_root)(extensions) )
FC_REFLECT_DERIVED( morphene::protocol::signed_block_header, (morphene::protocol::block_header), (witness_signature) )
