...
//
// Place MORPHENE_DEFINE_OPERATION_TYPE in a .cpp file to define
// functions related to your operation type
//
#define MORPHENE_DEFINE_OPERATION_TYPE( OperationType )                       \
                                                                           \
namespace morphene { namespace protocol {                                     \
                                                                           \
void operation_validate( const OperationType& op )                         \
{                                                                          \
   op.visit( morphene::protocol::operation_validate_visitor() );              \
}                                                                          \
                                                                           \
...
{                                                                          \
   op.visit( morphene::protocol::get_required_auth_visitor( active, owner, posting, other ) ); \
}                                                                          \
                                                                           \
} } /* morphene::protocol */
