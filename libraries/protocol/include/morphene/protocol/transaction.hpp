...
using fc::ecc::canonical_signature_type;
   ...
   struct signed_transaction : public transaction
   {
      ...
      set<public_key_type> get_required_signatures(
         ...
         uint32_t max_recursion = MORPHENE_MAX_SIG_CHECK_DEPTH,
         uint32_t max_membership = MORPHENE_MAX_AUTHORITY_MEMBERSHIP,
         uint32_t max_account_auths = MORPHENE_MAX_SIG_CHECK_ACCOUNTS,
...
FC_REFLECT( morphene::protocol::transaction, (ref_block_num)(ref_block_prefix)(expiration)(operations)(extensions) )
FC_REFLECT_DERIVED( morphene::protocol::signed_transaction, (morphene::protocol::transaction), (signatures) )
FC_REFLECT_DERIVED( morphene::protocol::annotated_signed_transaction, (morphene::protocol::signed_transaction), (transaction_id)(block_num)(transaction_num) );
