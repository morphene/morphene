...
#include <morphene/protocol/fixed_string.hpp>
...
namespace morphene {
   ...
   namespace protocol {
      ...
      #define MORPHENE_INIT_PUBLIC_KEY (morphene::protocol::public_key_type(MORPHENE_INIT_PUBLIC_KEY_STR))
...
namespace fc
{
    void to_variant( const morphene::protocol::public_key_type& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  morphene::protocol::public_key_type& vo );
    void to_variant( const morphene::protocol::extended_public_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, morphene::protocol::extended_public_key_type& vo );
    void to_variant( const morphene::protocol::extended_private_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, morphene::protocol::extended_private_key_type& vo );
}

FC_REFLECT( morphene::protocol::public_key_type, (key_data) )
FC_REFLECT( morphene::protocol::public_key_type::binary_key, (data)(check) )
FC_REFLECT( morphene::protocol::extended_public_key_type, (key_data) )
FC_REFLECT( morphene::protocol::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( morphene::protocol::extended_private_key_type, (key_data) )
FC_REFLECT( morphene::protocol::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_TYPENAME( morphene::protocol::share_type )

FC_REFLECT( morphene::void_t, )
