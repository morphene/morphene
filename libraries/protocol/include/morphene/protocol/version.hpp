...
/*
 * This class represents the basic versioning scheme of the Morphene blockchain.
...
{
   class variant;
   void to_variant( const morphene::protocol::version& v, variant& var );
   void from_variant( const variant& var, morphene::protocol::version& v );

   void to_variant( const morphene::protocol::hardfork_version& hv, variant& var );
   void from_variant( const variant& var, morphene::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( morphene::protocol::version, (v_num) )
FC_REFLECT_DERIVED( morphene::protocol::hardfork_version, (morphene::protocol::version), )

FC_REFLECT( morphene::protocol::hardfork_version_vote, (hf_version)(hf_time) )
