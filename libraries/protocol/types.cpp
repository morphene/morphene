...
namespace morphene { namespace protocol {
    ...
    public_key_type::public_key_type( const std::string& base58str )
    {
      ...
      //        to make public_key_type API more similar to address API
       std::string prefix( MORPHENE_ADDRESS_PREFIX );
    ...
    public_key_type::operator std::string() const
    {
       ...
       return MORPHENE_ADDRESS_PREFIX + fc::to_base58( data.data(), data.size() );
    }
...
namespace fc
{
    ...
    {
        vo = morphene::protocol::public_key_type( var.as_string() );
    }
    ...
    {
       vo = morphene::protocol::extended_public_key_type( var.as_string() );
    }
    ...
    {
       vo = morphene::protocol::extended_private_key_type( var.as_string() );
    }
} // fc
