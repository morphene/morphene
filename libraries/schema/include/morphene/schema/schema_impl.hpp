...
#define MORPHENE_DECLARE_SCHEMA_CLASS( is_reflected, is_enum )  \
template< typename ObjectType >                                 \
struct schema_impl< ObjectType, is_reflected, is_enum >         \
   : public abstract_schema                                     \
{                                                               \
MORPHENE_SCHEMA_TEMPLATE_CLASS_BODY( schema_impl )              \
};

// Templated version of macro includes some method definitions
#define MORPHENE_SCHEMA_TEMPLATE_CLASS_BODY( CLASSNAME )        \
...
#define MORPHENE_SCHEMA_CLASS_BODY( CLASSNAME )                 \
...
#define MORPHENE_SCHEMA_DEFINE_CLASS_METHODS( CLASSNAME )       \
...
MORPHENE_DECLARE_SCHEMA_CLASS( false, false )
MORPHENE_DECLARE_SCHEMA_CLASS(  true, false )
MORPHENE_DECLARE_SCHEMA_CLASS(  true,  true )
