...
def parse_arguments(src_default):
    ...
    parser = MyParser(description="Helper function to call cmake with appropriate configuration to build Morphene.")
    ...
    parser.add_argument("--src", dest="source_dir", metavar="SOURCEDIR", type=convert_to_dir, default=argparse.SUPPRESS, 
                        help="Morphene source directory (if omitted, will assume is at ../.. relative to location of this script)")
