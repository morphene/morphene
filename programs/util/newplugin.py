...
target_link_libraries( {plugin_provider}_{plugin_name} morphene_app morphene_chain morphene_protocol )
...
{{
   public:
      {plugin_name}_api( const morphene::app::api_context& ctx );
...
class {plugin_name}_plugin : public morphene::app::plugin
{{
   public:
      {plugin_name}_plugin( morphene::app::application* app );
...
{{
   public:
      {plugin_name}_api_impl( morphene::app::application& _app );
...
{plugin_name}_api_impl::{plugin_name}_api_impl( morphene::app::application& _app ) : app( _app )
{{}}
...
{plugin_name}_api::{plugin_name}_api( const morphene::app::api_context& ctx )
{{
...
{{
   public:
      {plugin_name}_plugin_impl( morphene::app::application& app );
...
{plugin_name}_plugin_impl::{plugin_name}_plugin_impl( morphene::app::application& app )
  : _app(app) {{}}
...
{plugin_name}_plugin::{plugin_name}_plugin( morphene::app::application* app )
   : plugin(app)
{{
...
MORPHENE_DEFINE_PLUGIN( {plugin_name}, {plugin_provider}::plugin::{plugin_name}::{plugin_name}_plugin )
""",
}
...
def main(argv):
    ...
    parser.add_argument("provider", help="Name of plugin provider (morphene for plugins developed by Morphene)")
